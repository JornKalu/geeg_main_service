...
def create_user_with_relevant_rows(db: Session, username: str=None, phone_number: str=None, email: str = None, password: str = None, first_name: str = None, other_name: str = None, last_name: str = None, is_staff: int = 0):
    user_type = 1
    if is_staff == 1:
        user_type = 2
